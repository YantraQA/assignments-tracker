...
public class DeleteRequestStepdefs extends TestBase {
	...
	public void i_hit_the_api_with_delete_request() {
	  testContext.resp = testContext.req_spec.when().delete("public-api/users/" + testContext.newUserID + "4552342");
	...
	public void api_should_delete_the_user() {
	  ...
	  .assertThat()
	  .body("_meta.sucess", equalTo(false))
	...
	public void get_request_to_the_user_should_not_return_the_user() {
		...
		testContext.scn.write("get response after delete: " +resp_get.asString());
