...
public class SearchPageObjects extends Interact {
	...
	public String ClickOnProductLink(int productIndex)
	{
		...
		scn.write("Clicked on product id: " + productIndex + "ProductLink");
	...
	public String ClickOnProductLink(String productTextContains)
	{
		...
		{
			scn.write("Unable to click on Product containing text as :" +productTextContains +  "No product found with maintoined text");
			Assert.fail("Unable to click on Product containing text as :" +productTextContains +  "No product found with maintoined text");
		}
