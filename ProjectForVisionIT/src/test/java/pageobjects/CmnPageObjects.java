...
public class CmnPageObjects extends Interact {
	...
	private String hamburger_menu_categary_link_xpath="//div[@id='hmenu-content']//div[text()='%s']";
	private String hamburger_menu_sub_categary_link_xpath="//div[@id='hmenu-content']//a[text()='%s']";
	...
	{
		By byElement = By.xpath(String.format(hamburger_menu_categary_link_xpath, linkText));
	...
	{
		By byElement = By.xpath(String.format(hamburger_menu_sub_categary_link_xpath, linkText));
		clickElement(byElement);
		scn.write("Clicked On Hamburger Menu Sub Category Link: " + linkText);
		logger.info("Clicked On Hamburger Menu Sub Category Link: " + linkText);
	}
