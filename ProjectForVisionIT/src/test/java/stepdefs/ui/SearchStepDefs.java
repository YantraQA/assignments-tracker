...
public class SearchStepDefs extends TestBase{
	...
	@When("I click on hambueger menu with sub category as {string}")
	public void i_click_on_hambueger_menu_with_sub_category_as(String subCategory) 
	{
	    testContextUI.getCmnPageObjects().ClickOnHamburgerMenuProductSubCategoryLink(subCategory);
	}

	@Then("Search result are displayed for products related to {string}")
	public void search_result_are_displayed_for_products_related_to(String expectedTitle) throws Exception 
	{
