...
public class TestContextUI {
	...
	private ProductDescriptionObjects productDescriptionObject;
	...
	{
		return productDescriptionObject;
	}
	...
	public void initializePageObjectClasses(WebDriver driver,Scenario scn) 
	{
		...
		productDescriptionObject = new ProductDescriptionObjects(driver,scn);
	}
