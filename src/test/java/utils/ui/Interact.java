...
public abstract class Interact {
	...
	public WebElement setElement(By by, String text) {
		...
		logger.info("Element is sent with text as: " + text + "Element Desccription: " + by.toString());
		return element;
	}
	...
	public File takeScreenShotAsFile(By by) {
		TakesScreenshot shot = (TakesScreenshot)driver;
		logger.info("Screen Shot taken for element and returned as a file. By description: " + by.toString());
		return shot.getScreenshotAs(OutputType.FILE);
	}
